...
class Node:
    ...
    def __init__(self,data = {'single_room_price' : 0}):
...
class HotelFinder:
    ...
    def __init__(self):
        ...
        for hotel in self.hotels:
            ...
            self.hotelsTreeByPrice.insert_price(hotel) # insert in search tree
        pass
    ...
    def getTheBestChoise(self):
        ...
        star = 1
        bestHotel = None
        data = self.hotelsTreeByPrice.find_price(money)

        if data is None:
            print('hotel with price not found')
        else:
